...
describe('SignUp Controller', () => {
  test('Should retrun 400 if no name is proveided', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
  ...
  test('Should retrun 400 if no email is proveided', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
  ...
  test('Should retrun 400 if no password is proveided', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
  ...
  test('Should retrun 400 if no passwordConfirmation is proveided', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
  ...
  test('Should retrun 200 if valid data is provided', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'valid_name',
